    ...
    'form' => [
        ...
        'tabs' => [
	        'fields' => [
                ...
                'display[button4_enable]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'thoughtco.kitchendisplay::default.label_button4_status',
		            'type' => 'switch',
					'default' => TRUE,
	            ],
	            'display[button4_text]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'thoughtco.kitchendisplay::default.label_button4_text',
		            'type' => 'text',
					'default' => 'Completed',
		            'span' => 'left',
					'cssClass' => 'flex-width',
		            'trigger' => [
		                'action' => 'show',
		                'field' => 'display[button4_enable]',
		                'condition' => 'checked',
		            ],
	            ],
	            'display[button4_status]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'thoughtco.kitchendisplay::default.label_button4_status',
		            'type' => 'select',
		            'options' => ['Admin\Models\Statuses_model', 'getDropdownOptionsForOrder'],
	            ...
	            'display[button4_color]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'lang:thoughtco.kitchendisplay::default.label_button4_color',
		            'type' => 'colorpicker',
					'default' => '#f1c40f',
		            'span' => 'left',
					'cssClass' => 'flex-width',
				...
				'display[button5_enable]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'thoughtco.kitchendisplay::default.label_button5_status',
		            'type' => 'switch',
					'default' => TRUE,
	            ],
	            'display[button5_text]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'thoughtco.kitchendisplay::default.label_button5_text',
		            'type' => 'text',
					'default' => 'Completed',
		            'span' => 'left',
					'cssClass' => 'flex-width',
		            'trigger' => [
		                'action' => 'show',
		                'field' => 'display[button5_enable]',
		                'condition' => 'checked',
		            ],
	            ],
	            'display[button5_status]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'thoughtco.kitchendisplay::default.label_button5_status',
		            'type' => 'select',
		            'options' => ['Admin\Models\Statuses_model', 'getDropdownOptionsForOrder'],
	            ...
	            'display[button5_color]' => [
	                'tab' => 'lang:thoughtco.kitchendisplay::default.tab_buttons',
		            'label' => 'lang:thoughtco.kitchendisplay::default.label_button5_color',
		            'type' => 'colorpicker',
					'default' => '#f1c40f',
		            'span' => 'left',
					'cssClass' => 'flex-width',
